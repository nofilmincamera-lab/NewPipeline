#!/usr/bin/env python3
"""
Full scrape of worldline.com and docs.connect.worldline-solutions.com
"""
...
async def scrape_site(url: str, config: dict, db_conn: asyncpg.Connection, max_depth: int = 5, max_pages: int = 500, max_duration_seconds: int = None):
...
async def main():
    """Run full scrape of both Worldline sites."""
    # Load configuration
        ...
        for site_url in sites:
            try:
                results = await scrape_site(
                    ...
                    conn,
                    max_depth=5,
                    max_pages=10000,  # High limit, time-based stopping at 3000 seconds
                    max_duration_seconds=3000  # 50 minutes per site
                )
